function [ fundamental, ZeroCrossAverage, SumShortAverag] = characterFunction( my2,fs )
...
ZeroCrossAverage=mean((zcr_sum/2));%Taking the average zero crossing frequency of all the frames
SumShortAverag=mean(short_energy);%Taking the average short energy of all the frames
%%
